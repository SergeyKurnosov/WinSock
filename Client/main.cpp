...
#define WIN32_LEAN_AND_MEAN   // только при поделючении #include<Windows.h>

#endif // !WIN32_LEAN_AND_MEAN   // только при поделючении #include<Windows.h>
...
int main()
{
	...
	//1) сщздаем переменные для хранения информации о сокете 
	...
	// Создаем поток который будет принимать сообщения от сервера
	DWORD dwThreadID = 0;
